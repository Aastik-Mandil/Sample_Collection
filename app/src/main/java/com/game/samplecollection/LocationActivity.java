...
//        });
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(LocationActivity.this,MonsoonActivity.class);
...
//        mGoogleMap.setBuildingsEnabled(false); //to disable building showing in google map
//        MarkerOptions markerOptions=new MarkerOptions().title("Title").position(new LatLng(0, 0))
//        mGoogleMap.addMarker(markerOptions);
//        mGoogleMap.getUiSettings().setZoomControlsEnabled(false);//not to zoom our map
    }
        ...
        if(result == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = googltApi.getErrorDialog(this, result,9002, new DialogInterface.OnCancelListener() {
                ...
                public void onCancel(DialogInterface task) {
                    Toast.makeText(LocationActivity.this, "Dialog is canclled by user", Toast.LENGTH_SHORT).show();
                }
            });
            dialog.show();
        }
